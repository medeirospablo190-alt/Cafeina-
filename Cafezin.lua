...
local WalkButton =
	CreateButton("WALK SPEED: OFF", 171)
...
local NoclipButton =
	CreateButton("NOCLIP: OFF", 259)

local ESPButton =
	CreateButton("ESP: ON", 303)
...
Player.CharacterAdded:Connect(function(NewCharacter)
	...
	-- Noclip permanece no estado escolhido
	if NoclipEnabled then

		for _, Part in
			ipairs(NewCharacter:GetDescendants()) do
