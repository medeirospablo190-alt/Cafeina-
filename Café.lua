...
local ScriptDescription =
    CreateLabel(
        ScriptInfo,
        "Painel adaptado para testes locais no Roblox Studio.\n"
        .. "Mantém o estilo CAFEÍNA e separa as áreas do sistema analisado.",
        12,
        GRAY,
        Enum.Font.Gotham
    )
...
CreateToggle(
    MountainVisual,
    "Cristais • visual de teste",
    false,
    function(State)
        Notify(
            "Mountain Lab",
            State
                and "Visual de cristais: teste ativado."
                or "Visual de cristais: teste desativado."
        )
    end
)
...
CreateToggle(
    MountainVisual,
    "Boulders • visual de teste",
    false,
    function(State)
        Notify(
            "Mountain Lab",
            State
                and "Visual de boulders: teste ativado."
                or "Visual de boulders: teste desativado."
        )
    end
)
...
CreateSlider(
    ...
    300,
    function(Value)
        States.MountainDetectionRadius =
            Value
    end
)
...
CreateToggle(
    MountainMovement,
    "Modo teleporte • Studio",
    false,
    function(State)
        Notify(
            "Mountain Lab",
            State
                and "Modo teleporte de laboratório ativado."
                or "Modo teleporte de laboratório desativado."
        )
    end
)
...
CreateToggle(
    ...
    function(State)
        Notify(
            "Mountain Lab",
            State
                and "Simulação de farm iniciada."
                or "Simulação de farm encerrada."
        )
    end
)
...
CreateToggle(
    MountainFarm,
    "Auto Pickup • simulação",
    false,
    function(State)
        Notify(
            "Mountain Lab",
            State
                and "Simulação de coleta ativada."
                or "Simulação de coleta desativada."
        )
    end
)
...
CreateToggle(
    ...
    function(State)
        Notify(
            "Mountain Lab",
            State
                and "Simulação de venda ativada."
                or "Simulação de venda desativada."
        )
    end
)
...
CreateToggle(
    ...
    function(State)
        Notify(
            "Mountain Lab",
            State
                and "Modo de teste Anti-AFK ativado."
                or "Modo de teste Anti-AFK desativado."
        )
    end
)
