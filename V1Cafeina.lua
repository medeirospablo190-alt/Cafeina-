...
-- CORREÇÃO:
-- Declarações antecipadas para que os botões usem
-- as mesmas funções locais definidas posteriormente.
local StartFlyController
local StopFlyController
local StartAimbot
local StopAimbot

-- Conexões de cada sistema: só existem enquanto o recurso está ativo.
...
local function SetupCharacter()
	...
	-- Guarda a velocidade original do jogo.
	-- O menu não altera o movimento ao ser iniciado.
...
local function CreateSection(Text, Accent)
	...
	Section.TextColor3 =
		Accent or Color3.fromRGB(190, 140, 220)
	...
	Line.BackgroundColor3 =
		Accent or Color3.fromRGB(120, 75, 150)
...
local FlySpeedCornerStroke =
	Instance.new("UIStroke")

FlySpeedCornerStroke.Thickness = 1
FlySpeedCornerStroke.Transparency = 0.78

FlySpeedCornerStroke.Color =
	Color3.fromRGB(150, 95, 185)

FlySpeedCornerStroke.Parent =
	FlySpeedFrame
...
local FOVCorner2Stroke =
	Instance.new("UIStroke")

FOVCorner2Stroke.Thickness = 1
FOVCorner2Stroke.Transparency = 0.78

FOVCorner2Stroke.Color =
	Color3.fromRGB(150, 95, 185)

FOVCorner2Stroke.Parent =
	FOVFrame
...
-- CORRIGIDO:
-- Não usa "local function" aqui porque a referência local
-- foi declarada no começo do script.
...
-- CORRIGIDO:
-- Mesma função local declarada no começo do script.
...
Player.CharacterAdded:Connect(
	...
	-- Desliga somente os sistemas ativos
	-- relacionados ao personagem anterior.
