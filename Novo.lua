...
local function EnableESP()
	...
	for _, TargetPlayer in ipairs(Players:GetPlayers()) do
		if TargetPlayer ~= Player then
			...
			ESPConnections["Character_" .. TargetPlayer.UserId] =
...
local function StopFly()
	...
	local WasFlying =
		BodyVelocity ~= nil
		or BodyGyro ~= nil
		or (Humanoid and Humanoid.PlatformStand)
